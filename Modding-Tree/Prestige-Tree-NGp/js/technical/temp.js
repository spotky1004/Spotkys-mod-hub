...
function updateTemp() {
	...
	const ngUpg = player.ng.upgrades;
	tmp.resMult = new Decimal(1)
	.mul(ngUpg.includes(11) ? 10 : 1)
	.mul(ngUpg.includes(12) ? 100 : 1)
	.mul(ngUpg.includes(13) ? 10 : 1)
	.mul(ngUpg.includes(22) ? layers.ng.upgrades[22].effect() : 1)
	.mul(ngUpg.includes(23) ? layers.ng.upgrades[23].effect() : 1);

	tmp.resPassive = ngUpg.includes(11) ? 0.01 : 0;
