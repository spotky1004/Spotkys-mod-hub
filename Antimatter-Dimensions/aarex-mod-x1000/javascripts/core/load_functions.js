	...
	doNGp3Init2()
        ...
        if (player.totalTimePlayed < 1 || inflationCheck || forceToQuantumAndRemove) {
			...
			document.getElementById("welcomeMessage").innerHTML =
				"<b style='font-size: 15px'>Long time, no see!</b>" +
				"<br>" +
				"Hello. I changed my mind. I'm continuing NG+3, as NG+3R is abandoned and went terrible. No updates will be here in this page, however." +
				"<br>" +
				'<a href="http://aarextiaokhiao.github.io/NG-plus-3/">Official NG+3 site</a> <b class="warning">(GO PLAY HERE INSTEAD)</b>'
